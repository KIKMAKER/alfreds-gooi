class SubscriptionsController < ApplicationController
  ...
  def show
    redirect_to admin_subscription_path(params[:id])
  end
  ...
  def complete
    ...
    if @subscription.update!(end_date: end_date)
      redirect_to admin_subscription_path(@subscription), notice: "#{@subscription.display_name}'s subscription marked complete"
    else
      redirect_to admin_subscription_path(@subscription), notice: "Error marking #{@subscription.display_name}'s subscription complete"
    end
  end
