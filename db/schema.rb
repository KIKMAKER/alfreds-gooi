...
ActiveRecord::Schema[7.2].define(version: 2026_07_15_120000) do
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.index ["skip_token"], name: "index_collections_on_skip_token", unique: true, where: "(skip_token IS NOT NULL)"
    t.index ["soil_bag_token"], name: "index_collections_on_soil_bag_token", unique: true, where: "(soil_bag_token IS NOT NULL)"
  ...
  create_table "driver_message_templates", force: :cascade do |t|
    t.string "segment", null: false
    t.text "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["segment"], name: "index_driver_message_templates_on_segment", unique: true
  end
  ...
  create_table "referrals", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "status", default: 0
    t.index ["referee_id", "referrer_id"], name: "index_referrals_on_referee_id_and_referrer_id", unique: true
